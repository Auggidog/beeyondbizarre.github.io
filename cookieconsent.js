parcelRequire = function (e, r, t, n) {
    ...
    "MwO6": [function (require, module, exports) {
        ...
        var n = {
            blacklist: Array.isArray(window.__SJ_TRACKING_DOMAINS__) ? [].concat((0, t.default)(e.DEFAULT_TRACKING_DOMAINS), (0, t.default)(window.__SJ_TRACKING_DOMAINS__.filter(function (t) {
                return t
        ...
        exports.patterns = n;
        var s = function (t, r) {
            return t && (!r || r !== e.TYPE_ATTRIBUTE) && n.blacklist.some(function (e) {
                return i(e, t)
        ...
        var l = function (t) {
            ...
            return n.blacklist.every(function (t) {
                return !i(t, e)
    ...
    "FOZT": [function (require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.removeElement = t, exports.push = o, exports.hashCode = a, exports.local = void 0;
        ...
        function t(e) {
            "function" == typeof e.remove ? e.remove() : e.parentNode && "function" == typeof e.parentNode.removeChild && e.parentNode.removeChild(e)
        }
    ...
    "H8LY": [function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.default = i, exports.observer = exports.backupScripts = void 0;
        ...
        var o = new MutationObserver(function (o) {
            for (var i = 0; i < o.length; i++)
                for (var n = o[i].addedNodes, u = function (o) {
                        var i = n[o];
                        if (1 === i.nodeType && "SCRIPT" === i.tagName) {
                            ...
                            if ((0, t.isOnBlacklist)(u, c)) {
                                ...
                                i.addEventListener("beforescriptexecute", function t(r) {
                                    i.getAttribute("type") === e.TYPE_ATTRIBUTE && r.preventDefault(), i.removeEventListener("beforescriptexecute", t)
                                }), (0, r.removeElement)(i)
                            }
                        }
                    }, c = 0; c < n.length; c++) u(c)
        });
    ...
    "uiXq": [function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
                ...
                try {
                    Object.defineProperties(i, {
                        src: {
                            ...
                            set: function (r) {
                                (0, t.isOnBlacklist)(r, i.type) && c.type.set.call(this, e.TYPE_ATTRIBUTE), c.src.set.call(this, r)
                            }
                        },
                        type: {
                            set: function (r) {
                    ...
                    console.warn("SpruceJoy Subscribe: unable to prevent script execution for script src ", i.src, ".\n", 'A likely cause would be because you are using a third-party browser extension that monkey patches the "document.createElement" function.')
                }
                return i
            }
        }
        ...
        function e(e, t) {
            if ("undefined" != typeof Symbol && Symbol.iterator in Object(e)) {
                var o = [],
                    ...
                    n = void 0;
                try {
                    for (var u, d = e[Symbol.iterator](); !(r = (u = d.next()).done) && (o.push(u.value), !t || o.length !== t); r = !0);
                } catch (i) {
                    l = !0, n = i
                } finally {
                    try {
    ...
    "xw6J": [function (require, module, exports) {
        ...
        module.exports = u, module.exports.default = module.exports, module.exports.__esModule = !0;
    }, {
    ...
    "ZXWT": [function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        ...
        var l = new RegExp("[|\\{}()[\\]^$+*?.]", "g"),
            s = function () {
                ...
                s.length < 1 ? (i.patterns.blacklist = [], i.patterns.whitelist = []) : (i.patterns.blacklist && (i.patterns.blacklist = i.patterns.blacklist.filter(function (t) {
                    return s.every(function (e) {
                        return "string" == typeof e ? !t.test(e) : e instanceof RegExp ? t.toString() !== e.toString() : void 0
                    })
                })), i.patterns.whitelist && (i.patterns.whitelist = [].concat((0, e.default)(i.patterns.whitelist), (0, e.default)(s.map(function (t) {
                    if ("string" == typeof t) {
                        var e = ".*" + t.replace(l, "\\$&") + ".*";
                        if (i.patterns.whitelist.every(function (t) {
                                return t.toString() !== e.toString()
                            })) return new RegExp(e)
                    } else if (t instanceof RegExp && i.patterns.whitelist.every(function (e) {
                            return e.toString() !== t.toString()
                        })) return t;
                    return null
                }).filter(Boolean)))));
                for (var o = document.querySelectorAll('script[type="'.concat(r.TYPE_ATTRIBUTE, '"]')), p = 0; p < o.length; p++) {
                    var u = o[p];
                    (0, i.willBeUnblocked)(u) && (n.backupScripts.blacklisted.push([u, "application/javascript"]), u.parentElement.removeChild(u))
                }
                var f = 0;
                (0, e.default)(n.backupScripts.blacklisted).forEach(function (e, r) {
                    ...
                    if ((0, i.willBeUnblocked)(l)) {
                        ...
                        for (var o in c.setAttribute("src", l.src), c.setAttribute("type", s || "application/javascript"), l) o.startsWith("on") && (c[o] = l[o]);
    ...
    "HRwc": [function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.open = _;
        ...
        function a() {
            ...
            a.styleSheet ? a.styleSheet.cssText = t : a.appendChild(document.createTextNode(t)), o.appendChild(a)
        }
    ...
    "Focm": [function (require, module, exports) {
        ...
        i || ((0, e.default)(), (0, r.default)(), document.addEventListener("DOMContentLoaded", function (e) {
            (0, n.open)()
        }));
    }, {
        "./observer": "H8LY",
